...
class ContradictionItem(BaseModel):
    ...
    doc_ref: str | None = Field(default=None, description="Source physical document ID or scan name")
    bbox: list[int] | None = Field(default=None, description="[x, y, w, h] coordinates in document crop")
    ...
    selected_resolution: str | None = Field(default=None, description="Clinician chosen resolution")
...
class DualCodingEntry(BaseModel):
    ...
    namaste_code: str | None = Field(default=None, description="Ministry of Ayush NAMASTE code, e.g. AYU-DG-0142")
    namaste_display: str | None = Field(default=None, description="NAMASTE terminology label")
    who_tm2_code: str | None = Field(default=None, description="WHO ICD-11 Traditional Medicine Module 2 code, e.g. TM2-SD-8812")
    who_tm2_display: str | None = Field(default=None, description="WHO TM2 Chapter 26 description")
    snomed_code: str | None = Field(default=None, description="SNOMED CT Concept ID, e.g. 196727004")
    snomed_display: str | None = Field(default=None, description="SNOMED CT term")
    icd11_mms_code: str | None = Field(default=None, description="Modern ICD-11 MMS code, e.g. MD90.0")
...
class PatientAudioView(BaseModel):
    ...
    consent_token: str | None = Field(default=None, description="Cryptographic SHA-256 consent token under DPDP Act 2023")
...
class ClinicalSynthesisResponse(BaseModel):
    ...
    ayush_dashavidha: DashavidhaReport | None = None
