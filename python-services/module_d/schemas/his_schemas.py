...
class OpenMRSPatientPayload(BaseModel):
    given_name: str
    family_name: str | None = "Patient"
    gender: str  # M or F or O
    birthdate: str  # YYYY-MM-DD
    age: int | None = None
    identifier: str  # ABHA ID or MediKiosk Queue ID
    identifier_type_uuid: str | None = "8d79403a-c2cc-11de-8d13-0010c6dffd0f"  # OpenMRS default ID type
    location_uuid: str | None = "8d6c3e12-c2cc-11de-8d13-0010c6dffd0f"
...
class OpenMRSEncounterPayload(BaseModel):
    ...
    provider_uuid: str | None = "c1c44249-2438-4541-9457-418f77341ad6"
...
class FHIRBundlePushRequest(BaseModel):
    ...
    clinician_id: str | None = "Dr. Sharma"
    hospital_name: str | None = "AIIMS New Delhi"
...
class FHIRBundlePushResponse(BaseModel):
    ...
    remote_fhir_id: str | None = None
    openmrs_encounter_uuid: str | None = None
    http_status: int
    target_endpoint: str
    timestamp: str
